...
public interface CaptchaService {
     ...
     * 验证码缓存名称
     */
    String CAPTCHA_CACHE_NAME = "CAPTCHA_Cache";
    /**
     * 验证码短信发送记录缓存名称
     */
    String CAPTCHA_SMS_SEND_CACHE_NAME = "CAPTCHA_SmsSendCache";

    /**
     * 验证码和手机号缓存
     */
    String CAPTCHA_PHONE_NUMBER_CACHE_NAME = "CAPTCHA_PhoneNumberCache";
